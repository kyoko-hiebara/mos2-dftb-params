...
oc.SPECS["Sb"] = dict(configuration="[Kr] 4d10 5s2 5p3",
                      valence=["5s", "5p"], scalarrel=True,
                      occupations={"5s": 2, "5p": 3})
...
def main():
    ...
    if len(study.trials) == 0:
        ...
        study.enqueue_trial({"Sb_rd": 7.9, "Sb_r5s": 5.3, "Sb_r5p": 5.3,
                             "Sb_swf": 2.0, "Sb_sh5s": 0.0, "Sb_sh5p": 0.0})
